---
name: shiiman-github:github-issue-list
...
```text
/shiiman-github:github-issue-list - Issue 一覧表示
...
使用方法:
  /shiiman-github:github-issue-list [オプション]
...
例:
  /shiiman-github:github-issue-list          # オープン Issue を表示
  /shiiman-github:github-issue-list --all    # 全 Issue を表示
  /shiiman-github:github-issue-list --mine   # 自分担当の Issue を表示
```
