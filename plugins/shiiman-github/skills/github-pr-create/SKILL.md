---
name: shiiman-github:github-pr-create
...
```text
/shiiman-github:github-pr-create - PR 作成・更新
...
使用方法:
  /shiiman-github:github-pr-create [タイトル] [オプション]
...
例:
  /shiiman-github:github-pr-create                    # PR を作成または更新
  /shiiman-github:github-pr-create --draft            # ドラフト PR を作成
  /shiiman-github:github-pr-create "タイトル"          # タイトルを指定して PR 作成
  /shiiman-github:github-pr-create --base develop     # develop ブランチ向けに PR 作成
```
