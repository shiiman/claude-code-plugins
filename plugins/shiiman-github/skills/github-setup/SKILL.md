---
name: shiiman-github:github-setup
...
```text
/shiiman-github:github-setup - GitHub 設定セットアップ
...
使用方法:
  /shiiman-github:github-setup [オプション]
...
例:
  /shiiman-github:github-setup              # 設定ファイルを生成
  /shiiman-github:github-setup --dry-run    # 生成予定のファイルを確認
  /shiiman-github:github-setup --force      # 既存ファイルを上書きして生成
```
