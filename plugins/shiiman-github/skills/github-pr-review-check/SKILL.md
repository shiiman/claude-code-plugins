---
name: shiiman-github:github-pr-review-check
...
```text
/shiiman-github:github-pr-review-check - レビュー指摘対応（PR 作成者向け）
...
使用方法:
  /shiiman-github:github-pr-review-check [PR番号] [オプション]
...
例:
  /shiiman-github:github-pr-review-check              # 現在のブランチの PR のレビューを確認
  /shiiman-github:github-pr-review-check 123          # PR #123 のレビューを確認
  /shiiman-github:github-pr-review-check --fix        # レビュー指摘を修正
  /shiiman-github:github-pr-review-check 123 --fix    # PR #123 のレビュー指摘を修正
```
