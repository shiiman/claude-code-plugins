---
name: shiiman-github:github-pr-list
...
```text
/shiiman-github:github-pr-list - PR 一覧表示

概要:
  オープン PR の一覧をレビュー状態と優先順位付きで表示する。

使用方法:
  /shiiman-github:github-pr-list [オプション]
...
例:
  /shiiman-github:github-pr-list          # オープン PR を表示
  /shiiman-github:github-pr-list --all    # 全 PR を表示
  /shiiman-github:github-pr-list --mine   # 自分作成の PR を表示
```
