...
```bash
python ${CLAUDE_PLUGIN_ROOT}/scripts/setup-user/slack_config.py set-user --user-id U01234567
```
...
```bash
python ${CLAUDE_PLUGIN_ROOT}/scripts/setup-user/slack_config.py clear
```
