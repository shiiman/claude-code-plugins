...
```bash
python ${CLAUDE_PLUGIN_ROOT}/scripts/google_forms.py responses --form-id <form-id>
```

### 最大件数を指定

```bash
python ${CLAUDE_PLUGIN_ROOT}/scripts/google_forms.py responses --form-id <form-id> --max 100
```
