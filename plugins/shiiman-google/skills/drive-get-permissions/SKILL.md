...
```bash
python ${CLAUDE_PLUGIN_ROOT}/scripts/drive-list/google_drive.py permissions --file-id <file-id>
```

## 使用例

```bash
python ${CLAUDE_PLUGIN_ROOT}/scripts/drive-list/google_drive.py permissions --file-id 1abc...xyz
```
