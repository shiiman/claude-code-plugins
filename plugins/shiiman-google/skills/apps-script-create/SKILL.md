...
```bash
python ${CLAUDE_PLUGIN_ROOT}/scripts/google_apps_script.py create --name "スクリプト名"
```

### スプレッドシートに紐付けて作成

```bash
python ${CLAUDE_PLUGIN_ROOT}/scripts/google_apps_script.py create --name "マクロ" --parent-id "スプレッドシートID"
```
