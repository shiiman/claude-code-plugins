...
例:
  /shiiman-claude:mcp              # 発話内容から操作を判定
  /shiiman-claude:mcp list         # MCP サーバー一覧を表示
  /shiiman-claude:mcp install      # MCP サーバーを追加
  /shiiman-claude:mcp remove       # MCP サーバーを削除
```
