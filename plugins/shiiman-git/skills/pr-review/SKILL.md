...
例:
  /pr-review                           # 現在のブランチの PR をレビュー（ローカル表示）
  /pr-review 123                       # PR #123 をレビュー（ローカル表示）
  /pr-review --submit                  # レビュー結果を GitHub に投稿
  /pr-review 123 --submit --approve    # PR #123 をレビューして Approve
```
