---
name: shiiman-git:git-commit-message-setup
...
```text
/shiiman-git:git-commit-message-setup - コミットメッセージ設定
...
使用方法:
  /shiiman-git:git-commit-message-setup [オプション]
...
例:
  /shiiman-git:git-commit-message-setup          # 現在の設定を表示
  /shiiman-git:git-commit-message-setup --set    # 命名規則を対話的に設定
```
